...
function E6C() {
    ...
    return(
        <div className='encounterContentContainer e6c'>
            ...
            <div className={encounterContentClass}>
                ...
                <div className='encounterSection challengeMode'>
                    ...
                    <ul style={{paddingLeft: '20px'}}>
                        ...
                        <li className='encounterBulletPoint'>
                            Gaze Holder's cannot be hit by an Ogre's Venom
                        </li>
                        <li className='encounterBulletPoint'>
                            Guardians cannot take any damage from a Cursed Thrall
                        </li>
                        <li className='encounterBulletPoint'>
                            Adepts are not allowed to frenzy any acolytes
                        </li>
                        <li className='encounterBulletPoint'>
                            Acolytes can only be killed if they are frenzied **yuck**
                        </li>
                        <li className='encounterBulletPoint'>
                            A guardian cannot stay in a pool of light for longer than XXX second
                        </li>
                        <li className='encounterBulletPoint'>
                            The fireteam must use all six Orbs of Reclaimed Light in each damage phase, without dropping or losing Golgoroth's Gaze
                        </li>
                        <li className='encounterBulletPoint'>
                            The Obelisk activates at 3 deaths
                        </li>
                        <li className='encounterBulletPoint'>
